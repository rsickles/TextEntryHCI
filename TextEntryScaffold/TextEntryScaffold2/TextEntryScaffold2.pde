  ...
  if(!lettersClicked) {
    ...
    */
    ...
    if(letterPanel == "_<") {
      stroke(153);
      fill(255);
      rect(150, 200+sizeOfInputArea/3, sizeOfInputArea/2, sizeOfInputArea/3);
      rect(150+sizeOfInputArea/2, 200+sizeOfInputArea/3, sizeOfInputArea/2, sizeOfInputArea/3);
      fill(0);
      textAlign(CENTER);
      text("_", 150 + sizeOfInputArea/4, 200+sizeOfInputArea/3 + sizeOfInputArea/6);
      text("<", 150+sizeOfInputArea/3 + sizeOfInputArea/4, 200+sizeOfInputArea/3 + sizeOfInputArea/6);
    }
    if(letterPanel == "abc") {
      stroke(153);
      fill(255);
...
void mousePressed()
{
  ...
  if(started) {
    if(!lettersClicked) {
      if (didMouseClick(150, 200, sizeOfInputArea/3, sizeOfInputArea/3)) //check if click space/backspace
      {
        lettersClicked = true;
        letterPanel = "_<";
      }
      ...
      if( letterPanel == "_<") {
        if (didMouseClick(150, 200+sizeOfInputArea/3, sizeOfInputArea/2, sizeOfInputArea/3)){ 
          currentTyped+=" ";
        }
        else if(didMouseClick(150+sizeOfInputArea/2, 200+sizeOfInputArea/3, sizeOfInputArea/2, sizeOfInputArea/3)){
          currentTyped = currentTyped.substring(0, currentTyped.length()-1);
        }
      }
      else if( letterPanel == "abc") {
